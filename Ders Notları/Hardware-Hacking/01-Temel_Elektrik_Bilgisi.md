...
- **Aktif Elemanlar :** Diyot, Transistör, Entegre Devre                                                                          
...
- **Açık Devre :** Kablo kopuktur veya anahtar kapalıdır. Akım geçmez.                                             
- **Kapalı Devre :** Yol tamamlanmıştır, sistem çalışır.                                                                               
- **Kısa Devre :** Akımın "kolay yolu" seçerek dirençsiz bir hattan gitmesidir. Bu durum tehlikelidir çünkü aşırı ısınma ve yangın çıkarabilir. 
